    ...
    <div class="w-4/5 mx-auto">
        ...
        <div class="flex flex-wrap -mx-4 mb-8 border-b-2 border-gray-100">
            ...
            <div class="sm:w-3/5 mb-8 px-4">
                <h2 class="text-2xl title-font font-medium text-gray-900 my-2">{{ $video->title }}</h2>
                ...
                <a href="https://youtube.com/watch?v={{ $video->id }}" target="_blank" rel="nofollow" class="text-gray-900 inline-flex items-center hover:underline">Watch Now
