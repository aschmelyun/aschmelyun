...
@section('content')
    <div class="flex">
        <div class="w-7/12">
            <h1 class="text-5xl font-semibold">Hey, Andrew Schmelyun here!</h1>
            <div class="text-5xl font-semibold mt-16">I'm a full-stack PHP developer with a love for <span class="lang lang-laravel">Laravel</span>, <span class="lang lang-vue">Vue</span> + <span class="lang lang-docker">Docker</span>.</div>
            <div class="flex items-center mt-24">
                <a class="block mr-12 hover:opacity-50 transition-opacity duration-200" href="https://github.com/aschmelyun" target="_blank" rel="noreferrer">
                ...
                <a class="block mr-12 hover:opacity-50 transition-opacity duration-200" href="https://twitter.com/aschmelyun" target="_blank" rel="noreferrer">
                ...
                <a class="block mr-12 hover:opacity-50 transition-opacity duration-200" href="https://youtube.com/aschmelyun" target="_blank" rel="noreferrer">
                ...
                <a class="block mr-12 hover:opacity-50 transition-opacity duration-200" href="https://dev.to/aschmelyun" target="_blank" rel="noreferrer">
    ...
    <div class="flex bg-gray-100 py-8 px-12 pb-12 mt-24">
    ...
    <div class="flex bg-gray-900 py-8 px-12 pb-12 mt-24">
        <div class="w-full text-center">
